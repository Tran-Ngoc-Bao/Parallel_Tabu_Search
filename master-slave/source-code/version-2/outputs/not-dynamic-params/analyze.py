#!/usr/bin/env python3
"""
Not-Dynamic-Params Analysis — 200 cities (randomize_worker_hyperparams=false)
Reads summary .txt files from each outputs/not-dynamic-params/<strategy>-<factor>/ subdir.
"""
...
def main():
    ...
    # ── Header ──────────────────────────────────────────────────────────────
    out.append("Not-Dynamic-Params Analysis — 200 cities  (randomize_worker_hyperparams=false)")
    out.append("=" * 80)
    out.append("")
