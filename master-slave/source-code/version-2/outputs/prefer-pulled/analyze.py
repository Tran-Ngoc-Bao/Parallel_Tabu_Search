#!/usr/bin/env python3
"""
Prefer-Pulled Analysis — 200 cities
Reads summary .txt files from each outputs/prefer-pulled/<ai>-<seg>-<pool>/ subdir.
"""
...
def main():
    ...
    # ── Header ──────────────────────────────────────────────────────────────
    out.append("Prefer-Pulled Analysis — 200 cities")
    out.append("=====================================")
    out.append("")
