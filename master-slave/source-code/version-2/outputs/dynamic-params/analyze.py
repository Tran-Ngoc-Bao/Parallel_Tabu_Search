#!/usr/bin/env python3
"""
Dynamic-Params Analysis — 200 cities (randomize_worker_hyperparams=true)
Reads summary .txt files from each outputs/dynamic-params/<strategy>-<factor>/ subdir.
"""
...
def main():
    ...
    # ── Header ──────────────────────────────────────────────────────────────
    out.append("Dynamic-Params Analysis — 200 cities  (randomize_worker_hyperparams=true)")
    out.append("=" * 76)
    out.append("")
