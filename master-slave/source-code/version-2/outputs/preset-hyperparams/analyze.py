#!/usr/bin/env python3
"""
Preset-Params Analysis — 200 cities (worker_hyperparams=preset)
Reads summary .txt files from each outputs/preset-hyperparams/<strategy>-<factor>/ subdir.
"""
...
def main():
    ...
    # ── Header ──────────────────────────────────────────────────────────────
    out.append("Preset-Params Analysis — 200 cities  (worker_hyperparams=preset)")
    out.append("=" * 64)
    out.append("")
