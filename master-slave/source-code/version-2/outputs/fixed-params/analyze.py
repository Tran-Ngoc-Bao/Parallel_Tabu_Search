#!/usr/bin/env python3
"""
Fixed-Params Analysis — 200 cities (worker_hyperparams=fixed)
Reads summary .txt files from each outputs/fixed-params/<strategy>-<factor>/ subdir.
"""
...
def main():
    ...
    # ── Header ──────────────────────────────────────────────────────────────
    out.append("Fixed-Params Analysis — 200 cities  (worker_hyperparams=fixed)")
    out.append("=" * 64)
    out.append("")
